...
const formsToselect = [
    ...
    {text: "Quasi Bicylinder", typeCoords: 'cartesian', udef: PI, vdef: PI/2, nb_steps_u: 128, nb_steps_v: 128,
        fx: "(cucv)***2", fy: "(svcu)***2", fz: "(e-2)s(u+(5/12)cusu)", alpha: "pi/4", beta: "", theta: "", suit: true,
        orient: {axis: "X", direction: -1, alpha: PI/8, beta: -PI/8, distance: 6},
    },

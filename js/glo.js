...
class AnimationClock {
	...
	/** @private Flush accumulated wall-clock delta into _elapsed. */
	_update() {
...
var glo = {
	...
	regs: [
		{ exp: /\s/g, upd: "" },
		{ exp: /(.+)ù(.+)/g, upd: "$1*3m\(\.5\)ct*$2" },
		{ exp: /(.+)ù/g, upd: "$1*3m\(\.5\)ct" },
		{ exp: /ù(.+)/g, upd: "3m\(\.5\)ct*$1" },
		{ exp: /ù/g, upd: "3m\(\.5\)ct" },
		{ exp: /(?<![cs])a(?![\(bs])/g, upd: "a()" },
		{ exp: /b(?![\(s])/g, upd: "b()" },
		{ exp: /(?<![cp])o(?![\(])/g, upd: "o()" },
		{ exp: /c([^x\(tuv]*)x/g, upd: "cos($1x)" },
		{ exp: /c([^y\(tuv]*)y/g, upd: "cos($1y)" },
		{ exp: /c([^z\(tuv]*)z/g, upd: "cos($1z)" },
		{ exp: /s([^x\(tuv]*)x/g, upd: "sin($1x)" },
		{ exp: /s([^y\(tuv]*)y/g, upd: "sin($1y)" },
		{ exp: /s([^z\(tuv]*)z/g, upd: "sin($1z)" },
		...
		{ exp: /ca([^t\(auvp]*)t/g, upd: "(0.49999*cos($1t)+0.5)" },
		{ exp: /sa([^t\(auvp]*)t/g, upd: "(0.49999*sin($1t)+0.5)" },

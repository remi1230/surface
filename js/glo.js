...
var glo = {
	...
	formes:{
		...
		select:[
			...
			{text: "Curve tetra", typeCoords: 'cartesian', udef: PI, vdef: PI, nb_steps_u: 132, nb_steps_v: 132,  fx: "cu", fy: "cv", fz: "cupv", check: false, orient: {axis: "X", direction: -1, alpha: PI/3, beta: -PI/4, distance: 8} },
			...
			{text: "Hourglass", typeCoords: 'cartesian', udef: 4*PI, vdef: PI, nb_steps_u: 132, nb_steps_v: 132,  fx: ".3u", fy: ".3usv", fz: ".3ucvsu", check: false, orient: {axis: "X", direction: -1, alpha: PI/4, beta: -PI/4, distance: 20}},
			...
			{text: "Sphere", typeCoords: 'cartesian', udef: PI, vdef: PI/2, nb_steps_u: 131, nb_steps_v: 131,  fx: "cucv", fy: "sucv", fz: "sv", check: false, orient:{distance: 5}},
			...
			{text: "Torus square", typeCoords: 'cartesian', udef: PI, vdef: PI, nb_steps_u: 132, nb_steps_v: 64,  fx: "(cv + e)(cu)***2", fy: "(cv + e)(su)***2", fz: "(sv)***2", check: false, orient: {axis: "X", direction: -1, alpha: PI/4, beta: -PI/4, distance: 16.66}},
			...
			{text: "Twisted Torus", typeCoords: 'cartesian', udef: PI, vdef: PI, nb_steps_u: 132, nb_steps_v: 132,  fx: "(cv + 2)cu", fy: "(cv + 2)su", fz: "sv", alpha: "G(cv)", beta:"G(cv)-0.8", theta: "", check: false, orient: {axis: "X", direction: 1, alpha: PI/2, beta: 0, distance: 15}},
			{text: "Waves", typeCoords: 'cartesian', udef: 9*PI, vdef: 9*PI, nb_steps_u: 512, nb_steps_v: 512,  fx: ".125u", fy: ".125v", fz: ".125(2s(h(u,v)))", beta: "-h(u,v)/20", check: false, orient: {distance: 15, axis: "Z", direction: 1, alpha: PI/8, beta: -PI/8}},
			{text: "Bicylinder S", typeCoords: 'cartesian', udef: PI, vdef: PI/2, nb_steps_u: 132, nb_steps_v: 132,  fx: "(cucv)***2", fy: "(svcu)***2", fz: "Q/2s(u)", alpha: "", beta: "", check: false, suit: true, orient: {axis: "X", direction: -1, alpha: 5*PI/8, beta: -PI/8, distance: 6}},
			{text: "Cube", typeCoords: 'cartesian', udef: PI, vdef: PI/2, nb_steps_u: 132, nb_steps_v: 132,  fx: "(cucv)***2", fy: "(sucv)***2", fz: "Q/2(sv)***0", alpha: "", theta: "pi/4", check: false, suit: true, orient: {axis: "X", direction: -1, alpha: 3*PI/4, beta: -7*PI/6, distance: 6}},
			{text: "Egg", typeCoords: 'cartesian', udef: PI, vdef: PI/2, nb_steps_u: 133, nb_steps_v: 133,  fx: "", fy: "((pow(36 - su², 0.5) + cu)cu)/4-0.225", fz: "su", beta: "v", check: false, suit: true, orient: {axis: "X", direction: 1, alpha: 0, beta: -PI/8, distance: 7}},
			{text: "Glass", typeCoords: 'cartesian', udef: PI, vdef: 3*PI/8, nb_steps_u: 255, nb_steps_v: 255,  fx: "c(u+1)c(v+1.2)", fy: "s(u+1)c(v+1.2)", fz: "(9/7)sv", alpha: "", check: false, suit: true, orient: {axis: "X", direction: -1, alpha: 3*PI/4, beta: -7*PI/6, distance: 8}},
			{text: "Heart", typeCoords: 'cartesian', udef: 2*PI, vdef: PI, nb_steps_u: 132, nb_steps_v: 132,  fx: "sv**3", fy: "-(13cv-5c(2v)-2c(3v)-c(4v))/16", fz: "u/128", alpha: "", check: false, suit: true, orient: {axis: "Z", direction: -1, alpha: 3*PI/4, beta: -7*PI/6, distance: 5}},
			{text: "Horn", typeCoords: 'cartesian', udef: PI/2, vdef: PI/2, nb_steps_u: 132, nb_steps_v: 132,  fx: "usv", fy: "ucv", fz: "(2u²-3)-0.5", beta: "u²", check: false, suit: true, orient: {axis: "X", direction: -1, alpha: 3*PI/4, beta: -7*PI/6, distance: 10}},
			...
			{text: "Hyperbola", typeCoords: 'spheric', udef: PI, vdef: PI, nb_steps_u: 96, nb_steps_v: 3,  fx: "1", fy: "2v", fz: "pi/8", alpha: "u", check: false, orient: {distance: 7, axis: "X", direction: -1, alpha: 0, beta: -PI/6}},
			{text: "Interrogation", typeCoords: 'spheric', udef: PI/2, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "u", fy: "u", fz: "v/2", alpha: "(cu**8)8", beta: "", theta: "", check: false, orient: {distance: 7, axis: "X", direction: 1, alpha: -3*PI/2, beta: PI}},
			{text: "Heart", typeCoords: 'spheric', udef: PI/2, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "u", fy: "u", fz: "v/2", alpha: "(cu**8)8suv", beta: "", theta: "", check: false, orient: {distance: 7, axis: "X", direction: -1, alpha: 0, beta: PI, offset:{z:-0.5}}},
			...
			{text: "Sphere meridians", typeCoords: 'spheric', udef: PI, vdef: PI/2, nb_steps_u: 132, nb_steps_v: 132,  fx: "1", fy: "v", fz: "u", check: false, orient: {distance: 7, axis: "X", direction: 1, alpha: -PI/8, beta: -PI/8} },
			...
			{text: "Ouroboros", typeCoords: 'spheric', udef: PI, vdef: PI/2, nb_steps_u: 256, nb_steps_v: 256, fx: "u", fy: "v", fz:"2picv²su²", alpha: "0.707cv", beta: "0.707cv", check: false, suit: true, orient: {distance: 7, axis: "X", direction: -1, alpha: 0, beta: 0}},
			...
			{text: "Inverse hyperbola", typeCoords: 'cylindrical', udef: PI, vdef: PI, nb_steps_u: 128, nb_steps_v: 127,  fx: "1/(4v)", fy: "u", fz: "4v", check: false, orient: {distance: 7, axis: "X", direction: -1, alpha: 0, beta: -PI/12}},
			{text: "Invsin hyperbola", typeCoords: 'cylindrical', udef: PI, vdef: PI, nb_steps_u: 128, nb_steps_v: 127,  fx: "1/(4v)", fy: "u", fz: "4v+s(6Gu)", check: false, orient: {distance :7,axis :"X" , direction :-1,alpha :0,beta :-PI/12}},
			{text:"Invspin hyperbola" , typeCoords :"cylindrical" , udef :PI,vdef :PI,nb_steps_u :63,nb_steps_v :161 , fx :"1/(12v)", fy :"u", fz :"(8+2/3)v", beta :"3vsi(v)/2", check:false , orient:{distance :7,axis :"X" , direction :-1,alpha :PI/4,beta :-PI/12}},
			{text:"Moebius" , typeCoords :"cylindrical" , udef :PI,vdef :1,nb_steps_u :132,nb_steps_v :132 , fx :"(1+ 0.5vc(0.5u))cu", fy :"(1+ 0.5vc(0.5u))su", fz :"0.5vs(0.5u)", check:false , orient:{distance :7,axis :"X" , direction :-1,alpha :PI/3,beta :-PI/12}},

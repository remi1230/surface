...
var glo = {
	...
	formes:{
		...
		select:[
			...
			{text: "Waves", typeCoords: 'cartesian', udef: 9*PI, vdef: 9*PI, nb_steps_u: 128, nb_steps_v: 128,  fx: ".125u", fy: ".125v", fz: ".125(2s(h(u,v)))", theta: "xct", check: false, orient: {distance: 15, axis: "Y", direction: -1, alpha: -PI/2, beta: 0}},
			...
			{text: "Heart", typeCoords: 'spheric', udef: PI/2, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "u", fy: "u", fz: "v/2", alpha: "", beta: "(cu**8)8suv", theta: "", check: false, orient: {distance: 6, axis: "X", direction: -1, alpha: 0, beta: PI}},

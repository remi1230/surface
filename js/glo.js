...
var glo = {
	...
	formes:{
		...
		select:[
			...
			{text: "Curve tetra", typeCoords: 'cartesian', udef: PI, vdef: PI, nb_steps_u: 132, nb_steps_v: 132,  fx: "cu", fy: "cv", fz: "cupv", check: false, orient: {axis: "X", direction: -1, alpha: PI/4, beta: -PI/4, distance: 8} },
			...
			{text: "Hypotenuse", typeCoords: 'cartesian', udef: 4*PI, vdef: PI, nb_steps_u: 512, nb_steps_v: 32,  fx: ".125uc(0.5v)/2", fy: ".125(h(u,v)+sv - 3)", fz: ".125h(u,v)u/12", beta: "h(u,v)/G", check: false, orient: {distance: 7, axis: "X", direction: 1, alpha: 0, beta: 0}},
			{text: "Moebius", typeCoords: 'cartesian', udef: PI, vdef: 1, nb_steps_u: 256, nb_steps_v: 12, fx: "(1+ 0.5vc(0.5u))cu", fy: "(1+ 0.5vc(0.5u))su", fz: ".5vs(0.5u)", check: false, orient:{distance: 7}},
			...
			{text: "Saddle", typeCoords: 'cartesian', udef: PI, vdef: PI, nb_steps_u: 16, nb_steps_v: 64,  fx: "u", fy: "v", fz: "uv", check: false, orient:{distance: 30}},
			{text: "Sphere", typeCoords: 'cartesian', udef: PI, vdef: PI/2, nb_steps_u: 131, nb_steps_v: 131,  fx: "cucv", fy: "sucv", fz: "sv", check: false, orient:{distance: 6}},
			...
			{text: "Twisted Torus", typeCoords: 'cartesian', udef: PI, vdef: PI, nb_steps_u: 132, nb_steps_v: 132,  fx: "(cv + 2)cu", fy: "(cv + 2)su", fz: "sv", alpha: "G(cv)", beta:"G(cv)", theta: "", check: false, orient: {axis: "X", direction: 1, alpha: PI/2, beta: 0, distance: 15}},
			...
			{text: "Egg", typeCoords: 'cartesian', udef: PI, vdef: PI/2, nb_steps_u: 133, nb_steps_v: 133,  fx: "", fy: "((pow(36 - su², 0.5) + cu)cu)/4", fz: "su", beta: "v", check: false, suit: true, orient: {axis: "X", direction: 1, alpha: 0, beta: -PI/8, distance: 7}},
			...
			{text: "Heart", typeCoords: 'cartesian', udef: 2*PI, vdef: PI, nb_steps_u: 132, nb_steps_v: 132,  fx: "sv**3", fy: "(13cv-5c(2v)-2c(3v)-c(4v))/16", fz: "u/128", alpha: "", check: false, suit: true, orient: {axis: "X", direction: -1, alpha: 3*PI/4, beta: -7*PI/6, distance: 5}},
			{text: "Horn", typeCoords: 'cartesian', udef: PI/2, vdef: PI/2, nb_steps_u: 132, nb_steps_v: 132,  fx: "usv", fy: "ucv", fz: "(2u²-3)", beta: "u²", check: false, suit: true, orient: {axis: "X", direction: -1, alpha: 3*PI/4, beta: -7*PI/6, distance: 10}},
			...
			{text: "Pseudosphere", typeCoords: 'cartesian', udef: 1.24, vdef: PI, nb_steps_u: 256, nb_steps_v: 92,  fx: "cvcu**pi", fy: "svcu**pi", fz: "cpow(sinh(u), e)", alpha: "", beta: "", check: false, suit: true, orient: {axis: "X", direction: -1, alpha: 0, beta: 0, distance: 10}},
			...
			{text: "Interrogation", typeCoords: 'spheric', udef: PI/2, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "u", fy: "u", fz: "v/2", alpha: "(cu**8)8", beta: "", theta: "", check: false, orient: {axis: "X", direction: 1, alpha: -3*PI/2, beta: PI}},
			{text: "Heart", typeCoords: 'spheric', udef: PI/2, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "u", fy: "u", fz: "v/2", alpha: "(cu**8)8suv", beta: "", theta: "", check: false, orient: {axis: "X", direction: 1, alpha: 0, beta: PI}},
			{text: "Nautile", typeCoords: 'spheric', udef: PI/2, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "cu", fy: "u", fz: "v", alpha: "cusu", beta: "cv", theta: "", check: false, orient: {axis: "Y", direction: -1, alpha: -5*PI/4, beta: 0} },
			...
			{text: "Twisted weathercock", typeCoords: 'spheric', udef: PI/2, vdef: PI, nb_steps_u: 128, nb_steps_v: 256, fx: "pi+c(12(u+v))", fy: "u", fz: "v", alpha: "u/1.1", beta: "", theta: "", check: false, orient: {axis: "X", direction: -1, alpha: PI, beta: -PI/12, distance: 20}},
			...
			{text: "Spiral 4", typeCoords: 'cylindrical', udef: PI/2, vdef: PI/2, nb_steps_u: 256, nb_steps_v: 256,  fx: "4uv", fy: "pi", fz: "u", alpha: "v", beta: "ch(u,v)pi", theta: "", check: false, orient: {axis: "X", direction: 1, alpha: PI/4, beta: -PI/8, distance: 80}},

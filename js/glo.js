...
var glo = {
	formes:{
		...
		select:[
			...
			{text: "Bicylinder S", typeCoords: 'cartesian', udef: PI, vdef: PI/2, nb_steps_u: 132, nb_steps_v: 132,  fx: "7cpow(c(u)c(v), 2)", fy: "7cpow(s(v)c(u), 2)", fz: "5s(u)", alpha: "", beta: "", check: false, suit: true, orient: {axis: "X", direction: -1, alpha: 5*PI/8, beta: -PI/8, distance: 80}},
			{text: "Cube", typeCoords: 'cartesian', udef: PI, vdef: PI/2, nb_steps_u: 132, nb_steps_v: 132,  fx: "7cpow(c(u)c(v), 2)", fy: "7cpow(s(u)c(v), 2)", fz: "5cpow(s(v), 0)", alpha: "", beta: "pi/4", check: false, suit: true, orient: {axis: "X", direction: -1, alpha: 3*PI/4, beta: -7*PI/6, distance: 80}},

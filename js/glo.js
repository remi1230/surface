...
var glo = {
	formes:{
		select:[
			...
			{text: "Oinon", typeCoords: 'cartesian', udef: 4*PI, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "ucos(v)", fy: "usin(v)", fz: "ucos(v)sin(u)", check: false, },
			{text: "Plan", typeCoords: 'cartesian', udef: 6*PI, vdef: 6*PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "u", fy: "v", fz: "", check: false, },
			{text: "Reactor", typeCoords: 'cartesian', udef: PI, vdef: 12.01, nb_steps_u: 128, nb_steps_v: 128,  fx: "cos(u)cos(v)", fy: "sin(u)cos(v)", fz: "sin(v)mz(10,2)", check: false, },
			...
			{text: "Glass", typeCoords: 'spheric', udef: 4.5*PI, vdef: PI/2, nb_steps_u: 256, nb_steps_v: 256,  fx: "8vhypot(cos(u8),sin(12vlog(v/10G+H/100+0.04)))", fy: "v+pi/4", fz: "3ufact_dec(v)", check: false, },
			...
			{text: "Pen mine", typeCoords: 'spheric', udef: PI/2, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "12(u+cos(u+cos(v+vsu)))", fy: "u+cu", fz: "v", check: false, },
			{text: "Propeller", typeCoords: 'spheric', udef: 4*PI, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "u", fy: "sin(.2v)", fz: "vcos(.2v)*sin(.2u)", check: false, },
			...
			{text: "Sphere meridians", typeCoords: 'spheric', udef: PI, vdef: PI/2, nb_steps_u: 128, nb_steps_v: 128,  fx: "12", fy: "v", fz: "u", check: false, },
			{text: "Sphere parallels", typeCoords: 'spheric', udef: PI/2, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "12", fy: "u", fz: "v", check: false, },
			...
			{text: "Twisted weathercock", typeCoords: 'spheric', udef: PI/2, vdef: PI, nb_steps_u: 128, nb_steps_v: 256, fx: "pi+cos(12(u+v))", fy: "u", fz: "v", alpha: "u/1.1", check: false, },

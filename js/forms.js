...
const formsToselect = [
    ...
    {text: "CircleSpi", typeCoords: 'spheric', udef: 1.5*PI, vdef: PI/2, nb_steps_u: 128, nb_steps_v: 128,
        ...
        lighting: {pos:{x: 1.5, y: -0.5, z: 0}, intensity: 2.5, specular: {intensity: 4, power: 2}}
    },
    {text: "Dbl tongue", typeCoords: 'spheric', udef: PI, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "u", fy: "v", fz: "Qcupvcv", check: false, orient: {distance: 15, axis: "X", direction: 1, alpha: 3*PI/4, beta: -PI/8}},

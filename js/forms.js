...
const formsToselect = [
    ...
    {text: "CosSin", typeCoords: 'cartesian', udef: 6*PI, vdef: 6*PI, nb_steps_u: 128, nb_steps_v: 128, uvParamsCoeff: {x: 0.133, y: 0.133},
        fx: ".125u", fy: ".125v", fz: ".125s(u+t)c(v+t)",
        orient: {axis: "X", direction: -1, alpha: PI/4, beta: -PI/4, distance: 10},
    },
    {text: "Curve tetra", typeCoords: 'cartesian', udef: PI, vdef: PI, nb_steps_u: 128, nb_steps_v: 128, uvParamsCoeff: {x: 1, y: 0.5},
    ...
    {text: "Pseudosphere", typeCoords: 'cartesian', udef: 3*PI/2, vdef: PI, nb_steps_u: 256, nb_steps_v: 92, uvCoeff: {x: 0.75, y: 0.75},

...
var glo = {
	formes:{
		...
		select:[
			...
			{text: "Bicylinder S", typeCoords: 'cartesian', udef: PI, vdef: PI/2, nb_steps_u: 132, nb_steps_v: 132,  fx: "7pc(c(u)c(v), 2)", fy: "7pc(s(v)c(u), 2)", fz: "5s(u)", alpha: "", beta: "", check: false, suit: true, orient: {axis: "X", direction: -1, alpha: 5*PI/8, beta: -PI/8, distance: 80}},
			{text: "Cube", typeCoords: 'cartesian', udef: PI, vdef: PI/2, nb_steps_u: 132, nb_steps_v: 132,  fx: "7pc(c(u)c(v), 2)", fy: "7pc(s(u)c(v), 2)", fz: "5pc(s(v), 0)", alpha: "", beta: "pi/4", check: false, suit: true, orient: {axis: "X", direction: -1, alpha: 3*PI/4, beta: -7*PI/6, distance: 80}},
			{text: "Egg", typeCoords: 'cartesian', udef: PI, vdef: PI/2, nb_steps_u: 133, nb_steps_v: 133,  fx: "", fy: "(pow(36 - su², 0.5) + cu)cu", fz: "4su", alpha: "v", check: false, suit: true, orient: {axis: "X", direction: 1, alpha: 0, beta: -PI/8, distance: 80}},
			...
			{text: "Horn", typeCoords: 'cartesian', udef: PI/2, vdef: PI/2, nb_steps_u: 132, nb_steps_v: 132,  fx: "usv", fy: "ucv", fz: "2u²-3", alpha: "u²", check: false, suit: true, orient: {axis: "X", direction: -1, alpha: 3*PI/4, beta: -7*PI/6, distance: 80}},
			...
			{text: "Ribbon", typeCoords: 'quaternion', udef: 0, vdef: PI/2, nb_steps_u: 1, nb_steps_v: 512,  fx: "12hc(u,v)", fy: "pc(u,0)", fz: "", alpha: "hc(u,v)", beta: "pihc(u,v)", check: false, orient: {axis: "Z", direction: 1, alpha: PI/16, beta: -PI/16}},

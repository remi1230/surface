...
var glo = {
	...
	formes:{
		...
		select:[
			...
			{text: "Torus", typeCoords: 'cartesian', udef: PI, vdef: PI, nb_steps_u: 128, nb_steps_v: 32,  fx: "(cv + e)cu", fy: "(cv + e)su", fz: "sv", check: true, orient: {axis: "X", direction: -1, alpha: PI/4, beta: -PI/5, distance: 16.66}},
			...
			{text: "Waves", typeCoords: 'cartesian', udef: 9*PI, vdef: 9*PI, nb_steps_u: 128, nb_steps_v: 128,  fx: ".125u", fy: ".125v", fz: ".375(s(h(u,v)))c.5t", theta: "xc.5t", check: false, orient: {distance: 15, axis: "Y", direction: 1, alpha: 0, beta: -PI/4}},
			...
			{text: "Flower", typeCoords: 'spheric', udef: PI, vdef: PI/2, nb_steps_u: 128, nb_steps_v: 128,  fx: "vh(c(u8),s(12v))", fy: "v+pi/4", fz: "u", check: false, orient: {distance: 7, axis: "X", direction: -1, alpha: 0, beta: -PI/4}},
			{text: "Interrogation", typeCoords: 'spheric', udef: PI/2, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "u", fy: "-u", fz: "v/2", alpha: "", beta: "(cu**8)8", theta: "", check: false, orient: {distance: 6, axis: "X", direction: -1, alpha: -7*PI/8, beta: 0}},
			{text: "Heart", typeCoords: 'spheric', udef: PI/2, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "u", fy: "u", fz: "v/2", alpha: "", beta: "(cu**8ct)8suv", theta: "", check: false, orient: {distance: 6, axis: "X", direction: -1, alpha: 0, beta: PI}},
			...
			{text: "Hyperbola", typeCoords: 'cylindrical', udef: PI, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "v²", fy: "u", fz: "v", check: false, orient: {distance: 37.5, axis: "X", direction: -1, alpha: 0, beta: -PI/12}},
			{text:"Moebius" , typeCoords :"cylindrical" , udef :PI,vdef :1,nb_steps_u :128,nb_steps_v :128 , fx :"(1+ 0.5vc(0.5u))cu", fy :"(1+ 0.5vc(0.5u))su", fz :"0.5vs(0.5u)", check:false , orient:{distance :5,axis :"X" , direction :-1,alpha :PI/3,beta :-PI/12}},
			...
			{text: "Spiral 2", typeCoords: 'cylindrical', udef: 2*PI, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "u", fy: "v", fz: "(3v+sufv)", beta: "", check: false, orient: {distance: 30, axis: "X", direction: -1, alpha: PI/4, beta: -PI/4}},
			{text: "Spiral 3", typeCoords: 'cylindrical', udef: 6*PI, vdef: PI, nb_steps_u: 128, nb_steps_v: 128,  fx: "uc(0.5v)/2", fy: "u+v", fz: "abs(u)u/12", check: false, orient: {distance :75,axis :"X" , direction :1,alpha :PI/4,beta :-PI/8}},
			{text:"Spiral 4" , typeCoords :"cylindrical" , udef :PI/2,vdef :PI/2,nb_steps_u :128,nb_steps_v :128 , fx :"4uv", fy :"pi", fz :"u", alpha :"c(pih(u,v))pi", beta :"v", theta:"", check:false , orient:{distance :30,axis :"X" , direction :1,alpha :PI/4,beta :-PI/8}},
		],
